    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="grid gap-3 mb-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full p-3 rounded-md font-semibold bg-red-500 text-white hover:bg-firstAlt hover:shadow-[0_8px_24px_rgba(255,0,0,0.4)] transition disabled:opacity-60"
        >
