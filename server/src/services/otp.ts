...
// =============== (signup flow) ================
export async function requestOtp({ username, email, password }) {

  // const otp = generateOtp();
  // const otpHash = await bcrypt.hash(otp, 10);
  const otpHash = "$2b$10$2907gTamS6WQVMRbmJ2.HuQcTNG/idydMIvwX2qOSn0jCN7hxMCSm";
...
//   const valid = otp = "$2b$10$2907gTamS6WQVMRbmJ2.HuQcTNG/idydMIvwX2qOSn0jCN7hxMCSm";
